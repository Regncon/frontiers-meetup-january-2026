...
func PresenterPage(isPresenter bool, errorMessage string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if errorMessage != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/root/presenter.templ`, Line: 133, Col: 18}
			}
		...
		if !isPresenter {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<p style=\"opacity: 0.85; margin-bottom: 1rem;\">Enter the presenter key to enable presenter controls on this device.</p><form method=\"post\" action=\"./login\" style=\"display:flex; gap:0.5rem; align-items:center; flex-wrap:wrap;\"><input type=\"password\" name=\"key\" placeholder=\"Presenter key\" autocomplete=\"current-password\" style=\"flex:1; min-width: 16rem; padding: 0.65rem 0.75rem; border-radius: 10px;\"> <button type=\"submit\" style=\"padding: 0.65rem 0.9rem; border-radius: 10px;\">Unlock</button></form>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<p style=\"opacity: 0.85; margin-bottom: 1rem;\">This device is currently in presenter mode.</p><form method=\"post\" action=\"./logout\"><button type=\"submit\" style=\"padding: 0.65rem 0.9rem; border-radius: 10px;\">Log out presenter mode</button></form>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
